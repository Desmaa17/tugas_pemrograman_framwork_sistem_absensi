...
Route::get('/absen/export', function (Illuminate\Http\Request $request) {
    $bulan = $request->bulan;
    $tahun = $request->tahun;

    return Excel::download(new RekapAbsensiBulananExport($bulan, $tahun), "rekap_absen_{$bulan}_{$tahun}.xlsx");
});
