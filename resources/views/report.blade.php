            ...
            <div class="MyTable">
                ...
                <tbody>
                    ...
                    <tr>
                        <td>{{ $no++ }}</td>
                        <td>{{ $a->nama}}</td>
                        <td>@if($a->absensis->where('keterangan', 'Hadir')->whereBetween('tanggal', [$from,$to])->count() == 0) - @else {{ $a->absensis->where('keterangan', 'Ijin')->whereBetween('tanggal', [$from,$to])->count() }} @endif </td>
